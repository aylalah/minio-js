...
export declare class CopySourceOptions {
    ...
    constructor({ Bucket, Object, VersionID, MatchETag, NoMatchETag, MatchModifiedSince, MatchUnmodifiedSince, MatchRange, Start, End, Encryption, }: ICopySourceOptions);
    validate(): boolean;
...
export declare class CopyDestinationOptions {
    ...
    constructor({ Bucket, Object, Encryption, UserMetadata, UserTags, LegalHold, RetainUntilDate, Mode, MetadataDirective, }: ICopyDestinationOptions);
    getHeaders(): RequestHeaders;
    validate(): boolean;
}
/**
